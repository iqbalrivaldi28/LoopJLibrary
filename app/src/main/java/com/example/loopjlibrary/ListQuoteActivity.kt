package com.example.loopjlibrary
...
import com.example.loopjlibrary.adapter.QuoteAdapter
import com.example.loopjlibrary.databinding.ActivityListQuoteBinding
...
class ListQuoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "All List of Quote" // Title Apps Bar
        supportActionBar?.setDisplayHomeAsUpEnabled(true) // Tombol Back ke HomePage
